This is a small project that showcases my skills in Python—Django framework as a back-end, along with my configuration skills with EC2 instances and RDS PostgreSQL, all hosted on AWS.
